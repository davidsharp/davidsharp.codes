...
const Icon = ({path,viewBox=siViewbox,style={}}) => <svg style={style} stroke="currentColor" fill="currentColor" stroke-width="0"  role="img" viewBox={viewBox} height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path d={path}/></svg>
...
const Twitter = () => <Icon style={{transform:'rotate(180deg)'}} path={siTwitter.path}/>
const Instagram = () => <Icon path={siInstagram.path}/>
const Threads = () => <Icon path={siThreads.path}/>
