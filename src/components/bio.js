...
style={{
  ...
  <p>David also pretends to be interested in design, learns Japanese 'for the culture', promises he'll one day make a video game (<A href="https://davidsharp.itch.io/puff-puff-pass-british-bulldog">solo this time</A>) and owns a guitar (and at least one pedal)</p>
  </div>
  <img
    style={{
      maxWidth:200,
