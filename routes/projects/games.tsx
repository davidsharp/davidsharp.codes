...
const ProjectsPage = ({ route }) => (
  <Layout route={route}>
    ...
    <Box header="Game Jams | 2024">
      ...
      <p>
        <Itch href="https://davidsharp.itch.io/star-ring">Star Ring</Itch>, a
        simple 3D "space" game made for Lowrez Jam 2024, an exercise in
        crunching a game into a canvas of 64 x 64 pixels
      </p>
    </Box>
    <Box header="Game Jams | 2023">
      ...
      <p>
        <Itch href="https://davidsharp.itch.io/pongaconda">Pongaconda</Itch>, a
        rough prototype of a game combining Pong and Snake, built in a few hours
        for PongJam
      </p>
      ...
      <BoxHeader>
        Desert Bus Bowling (for Desert Bus for Hope 2023 Game Jam)
      </BoxHeader>
      <p>
        <Itch href="https://davidsharp.itch.io/desert-bus-bowling">
          Desert Bus Bowling
        </Itch>, a simple 3D bowling game built for{" "}
        <Itch href="https://itch.io/jam/2023">
