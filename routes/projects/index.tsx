...
const ProjectsPage = ({route}) => (
  <Layout route={route}>
    ...
    <Box header="Personal Projects">
      ...
      <ul>
        <li><Tw href="https://twitter.com/yearinfractions">{`Year in Fractions`}</Tw>{`, a Twitter bot inspired by `}<Tw href="https://twitter.com/year_progress">{`@year_progress`}</Tw>{`, powered by Express, tweets daily how far through the year we are as a (usually approximate) fraction [retired]`}</li>
        ...
        <li><A href="https://bust-a-ghost.glitch.me/">{`Bust-a-Ghost`}</A>{`, a little "target practice" type game I threw together on a sick day`/*stick this and consnake in with games*/}</li>
      </ul>
    </Box>
    <Box header="Games">
      ...
      <p><A href="./projects/games">more...</A></p>
    </Box>
    ...
    <Box header="Other coding miscellany">
      ...
      <ul>
        ...
        <li><GH href="https://github.com/davidsharp/bangle-js-snake">davidsharp/bangle-js-snake</GH>{`, a simple proof-of-concept Snake clone using screen swipes to control direction`}</li>
      </ul>
      ...
      <ul>
        ...
        <li><span style={{textDecoration:'line-through'}}><A href="https://gist.github.com/davidsharp/e0bfa84a657ef113b3d59f24767b8314">{`COVID Stats`}</A>{`, a plugin that uses `}<A href="https://diseases.sh">{`diseases.sh`}</A>{` to get the country's COVID stats`}</span> <span class="small">(API no longer updated)</span></li>
