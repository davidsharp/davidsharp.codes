...
const ProjectsPage = ({ route }) => (
  <Layout route={route}>
    ...
    <Box header="Writing">
      <p>
        I don't have much in the way of writing online, but I did once write a
        blog post for my Japanese teacher{" "}
        <A href="https://www.stepupjapanese.com/blog/2018/05/gachapon">
          about gachapon
        </A>{" "}
